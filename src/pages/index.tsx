...
import SSIC from "/ssic.jpeg";
import Nauru from "/nauru.jpeg";
import Sosuu from "/sosuu.jpeg";
    ...
    <div className="sonota">
      ...
      <div className="card_style">
        ...
        <div className="card_format">
          <div className="card card-skin">
            <div className="card__imgframe">
              <img src={Focus} alt="" style={{width: "100%"}} />
            </div>
        ...
        <div className="card_format">
          <div className="card card-skin">
            <div className="card__imgframe">
              <img src={Kyomuka} alt="" style={{width: "100%"}} />
            </div>
            <div className="card__textbox">
        ...
        <div className="card_format">
          <div className="card card-skin">
            <div className="card__imgframe">
              <img src={SSIC} alt="" style={{width: "100%"}} />
            </div>
            <div className="card__textbox">
        ...
        <div className="card_format">
          <div className="card card-skin">
            <div className="card__imgframe">
              <img src={Nauru} alt="" style={{width: "100%"}} />
            </div>
            <div className="card__textbox">
        ...
        <div className="card_format">
          <div className="card card-skin">
            <div className="card__imgframe">
              <img src={Sosuu} alt="" style={{width: "100%"}} />
            </div>
            <div className="card__textbox">
        ...
        <div className="card_format">
          <div className="card card-skin">
            <div className="card__imgframe">
              <img src={Soinsuu2} alt="" style={{width: "100%"}} />
            </div>
            <div className="card__textbox">
