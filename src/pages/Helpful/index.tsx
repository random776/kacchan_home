...
export default function Result() {
    return (
        ...
        <div className="sonota">
            ...
            <p>こちらでは、東大（に限らず）理系生の実験などの計算に役立ちそうなツールをいくつか用意しております。ぜひご活用ください。</p>
            <h2 className="color2">進学選択</h2>
    <ul className="height">
      <li>
        基本平均点簡易計算ツール
        <a href="https://kihonheikin-calculator.onrender.com"
          >https://kihonheikin-calculator.onrender.com</a
        >
        <p>
          うp主はこんなちゃっちいツールで<a
            href="https://www.google.co.jp/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwiv5pidmeP9AhUIAN4KHWscAicQFnoECAsQAQ&url=https%3A%2F%2Fwww.utes.jp%2F&usg=AOvVaw1HkxqRgVzCPo7B9ILlqm6o"
            >UTES</a
      ...
      <li>
        ...
        <a href="https://kihonheikin-practice.onrender.com"
          >https://kihonheikin-practice.onrender.com</a
        >
    ...
    <ul>
      <li>
        ...
        <a href="https://standard-7j03.onrender.com"
          >https://standard-7j03.onrender.com</a
        >
      </li>
      <li>
        不確かさの伝播則計算ツール
        <a href="https://error-calculator.onrender.com"
          >https://error-calculator.onrender.com</a
        >
      </li>
    </ul>
    ...
    <ul>
      <li>
        ...
        <a href="https://vector-calculator.onrender.com"
          >https://vector-calculator.onrender.com</a
        >
        <p>
    ...
    <ul>
      <li>
        ...
        <a href="https://matrix-calculator-t7fc.onrender.com"
          >https://matrix-calculator-t7fc.onrender.com</a
        >
